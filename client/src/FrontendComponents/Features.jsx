  ...
  const featuresData = [
    {
      ...
      info:
        "Your files are stored on IPFS, not on centralized servers that can be compromised or shut down.",
    },
    {
      logoPath:
      ...
      info:
        "Smart contracts ensure secure file sharing with cryptographic proof of ownership and transfers.",
    },
    {
      logoPath:
      ...
      info:
        "Direct peer-to-peer file sharing without intermediaries means faster uploads and downloads.",
    },
    {
      logoPath:
      ...
      info:
        "Access your files from anywhere in the world as long as you have your wallet.",
    },
    {
      logoPath:
      ...
      info:
        "Share files instantly with anyone using just their Ethereum address.",
    },
    {
      logoPath:
      ...
      heading: "Simple Upload",
      info:
        "Drag, drop, and upload. Your files are immediately available on the decentralized web.",
    },
  ];
    ...
    <section className="features" id="features">
      <div className="feature_Container">
        <div className="feature_heading">
          ...
          <p>
            Everything you need to store, share, and manage your files in a
            decentralized world.
          </p>
        </div>
        <div className="featureBoxes">
          {featuresData.map(function (details, key) {
            return (<div key={key}><FeatureBox logoPath={details.logoPath} heading={details.heading} info={details.info} /></div>);
          })}
        </div>
      </div>
    </section>
