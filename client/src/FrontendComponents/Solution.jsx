      ...
      <div className="solutionContainer">
        <div className="solInfo">
          <div className="InfoText">
            <h2>Our Solution: True Decentralization</h2>
            <p>
              DecentralDrive uses blockchain technology and IPFS to give you
              complete control over your files. No intermediaries, no single
              points of failure, no privacy compromises.
            </p>
            <div className="KeyPoints">
              <div className="point1">
                ...
                <div className="pointtext">
                  <h3>IPFS Storage</h3>
                  <p>
                    Files are distributed across a global network, ensuring
                    permanent availability and redundancy.
                  </p>
                </div>
              </div>
              <div className="point2">
                ...
                <div className="pointtext">
                  ...
                  <p>
                    Smart contracts handle file ownership and sharing with
              ...
              <div className="point3">
                ...
                <div className="pointtext">
                  ...
                  <p>
                    No accounts to create or passwords to remember. Your wallet
                    is your identity.
                  </p>
                </div>
              </div>
